...
After graduating, I began building AMOS and asked Perry, a close friend since high school, to join me. David and Divvy later joined the team. Perry and Divvy are experts in system design and David is an expert in agentic AI as well as data conectivities. All four founders are technical and write code; we have built the core product ourselves without contractors.
