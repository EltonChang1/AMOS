...
- [Design proposal](papers/AMOS_design_proposal.pdf) - A step-by-step startup plan covering the product wedge, architecture, development phases, team, metrics, validation, and risks.
